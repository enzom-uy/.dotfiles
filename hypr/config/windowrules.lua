...
hl.window_rule({ match = { class = "^(vesktop|discord)$" }, monitor = PRIMARY_MONITOR, workspace = "6" })
...
hl.window_rule({ match = { class = "^(firefox|zen)$" }, opacity = "1.0 override", workspace = "2" })
